    ...
    <div class="px-6 pb-6">
      <div class="flex items-end gap-5 -mt-12 mb-6">
        ...
        <div class="pb-2 flex-1 min-w-0">
          ...
          <p class="text-sm text-slate-400 mt-0.5">Medlem siden <?= date('d/m/Y', strtotime($user['created_at'])) ?></p>
        </div>
      ...
      <div class="grid grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-slate-900/50 rounded-xl p-4 text-center">
          ...
          <p class="text-xs text-slate-500 mt-0.5">Svar</p>
        </div>
        <div class="bg-slate-900/50 rounded-xl p-4 text-center">
          <p class="text-sm font-semibold text-white"><?= timeAgo($user['last_seen']) ?></p>
          <p class="text-xs text-slate-500 mt-0.5">Sidst set</p>
        </div>
      </div>
    </div>
  </div>
